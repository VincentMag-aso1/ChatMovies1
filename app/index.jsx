...
export default function App() {
  return (
    <SafeAreaView className="bg-hot bg-pink-300 h-full">
        ...
        <View className="w-full justify-center, items-center min-h-screenh-[85vh] px-4">
              ...
              <View className="relative mt-5">
                  <Text className="text-2xl text-white font-u_bold text-center">
                   Watch Movies and enjoy your time
                  </Text>
              </View>
            <Text className="text-sm, font-j_bold text-gray-100 mt-7 text-center"> Invite your Friends to join ChatMovies
            </Text>
            <CustomButton
